...
// processes
void searchWaitTimeRR(ProcessType plist[], int n,int quantum) 
{ 
  /*
...
// Function to find the waiting time for all  
// processes 
void searchWaitTimeSJF(ProcessType plist[], int n)
{ 
      /*
...
// Function to find the waiting time for all  
// processes 
void searchWaitTime(ProcessType plist[], int n)
{ 
...
{ 
    //Function to find waiting time of all processes 
    searchWaitTimeRR(plist, n, quantum); 
...
{ 
    ...
    */
    ...
    qsort(plist, n, sizeof(ProcessType), compareFunction);
